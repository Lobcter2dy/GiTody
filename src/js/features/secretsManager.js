...
class SecretsManager {
    ...
    setupEventDelegation() {
        ...
        container.addEventListener('dblclick', (e) => {
            ...
            const itemId = secretItem.dataset.id;
            const itemType = secretItem.dataset.type;
    ...
    showAddModal() {
        ...
        const addPasswordBtn = modal.querySelector('.js-add-password');
        if (addPasswordBtn) {
            addPasswordBtn.addEventListener('click', () => this.showPasswordModal());
        }

        const addNoteBtn = modal.querySelector('.js-add-note');
        if (addNoteBtn) {
    ...
    viewPassword(id) {
        ...
        modal.innerHTML = `
            <div class="secrets-modal">
                ...
                <div class="secrets-modal-footer">
                    <button class="btn btn-secondary js-close-modal-btn">Закрыть</button>
                </div>
            </div>
        `;
        ...
        const closeBtnFooter = modal.querySelector('.js-close-modal-btn');
        if (closeBtnFooter) {
