...
/**
 * RepoManager — управляет списком репозиториев и файловой структурой в левой панели:
 * - Sidebar: список репозиториев, выделение активного
 * - Файловое дерево: рендер, сохранение цвета папки
 * - Методы выбора, добавления/импорта, открытия файла
 */
