...
### Добавлено
- Конфигурация шаблонов issues (config.yml) с опциями:
  - Отключение пустых issues (требуется использование шаблонов)
  - Ссылки на GitHub Discussions для вопросов
  - Ссылка на документацию
  - Ссылка на систему сообщения об уязвимостях
- Улучшенные шаблоны Bug Report и Feature Request с подробными комментариями
